...
class LoRaParameters:
    ...
    CHANNEL_DUTY_CYCLE_PROC = {868100000: 1 / 3, 868300000: 1 / 3, 868500000: 1 / 3, 868525000: 10 / 3}  # in procent
    CHANNEL_DUTY_CYCLE = {868100000: (1 / 100) / 3, 868300000: (1 / 100) / 3, 868500000: (1 / 100) / 3,
                          868525000: (10 / 100) / 3}  # not in procent
